...
class HomeViewModel: ObservableObject {
    ...
    func addReply(to commentId: String, reply: Reply) {
        // Push reply to Firebase for the given comment
    }
    ...
    func fetchReplies(for commentId: String) {
        // Fetch replies from Firebase and update the comment
    }
